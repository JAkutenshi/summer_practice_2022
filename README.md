...
| ### | C1            | C2       | C3        | Задача                                           |
| --- | ------------- | -------- | --------- | ------------------------------------------------ |
|  1  | Подопригора   | Пенкин   | Позолотин | Поиск мостов в графе                             |
|  2  | Ибатов        | Печеркин | Котов     | Сортировки: quicksort, bubble sort, bitonic sort |
|  3  | Александрович | Парфенов | Куртова   | Минимальное остовное дерево: алгоритм Прима      |
